...
export default function LifeHUD() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setLogs(prev => [...prev, { source: 'ERR', msg: 'CONNECTION LOST - IS BACKEND RUNNING?', color: 'text-red-600' }]);
    }
    setStatus('IDLE');
  };
    ...
    <div className="min-h-screen bg-black text-green-500 font-mono p-4 flex flex-col relative overflow-hidden">
      ...
      <div className="flex justify-between items-center border-b border-green-900/50 pb-4 mb-4 z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-widest text-yellow-500">SARA_OS <span className="text-xs align-top opacity-50">v0.9</span></span>
        </div>
